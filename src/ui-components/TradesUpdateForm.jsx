...
export default function TradesUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setSls(cleanValues.sls ?? []);
    setCurrentSlsValue(undefined);
    setTps(cleanValues.tps ?? []);
  ...
  return (
    ...
    >
      ...
      <TextField
        ...
        type="datetime-local"
        defaultValue={
          createdAt && convertToLocal(convertTimeStampToDate(createdAt))
        }
        onChange={(e) => {
      ...
      <TextField
        ...
        type="datetime-local"
        defaultValue={
          updatedAt && convertToLocal(convertTimeStampToDate(updatedAt))
        }
        onChange={(e) => {
          const date = new Date(e.target.value);
          if (!(date instanceof Date && !isNaN(date))) {
